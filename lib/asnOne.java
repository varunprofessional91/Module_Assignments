...
public class asnOne
{
    public static void main(String[] args)
    {
        ...
        byte bte1 = (byte)(bte*1);
        short shrt1 = (short)(shrt-3200);
        int intgr1 = intgr + 2147483647;
        ...
        System.out.println("Byte Arithmetic Ex 127 * 1 = "+bte1);
        System.out.println("Short Arithmetic Ex 32767 - 3200 = "+shrt1);
        System.out.println("Integer Arithmetic Ex 2147483647 + 2147483647 = "+intgr1);
        ...
        System.out.println("Double Arithmetic Ex 1.7e+308D-- = "+dble1);

        if(20==20)
        {

            System.out.println("Byte Ex bte1 % shrt1 = "+booln1);
        }
        else
            {
            System.out.println("Byte Ex bte1 % shrt1 = "+booln2);
        }
